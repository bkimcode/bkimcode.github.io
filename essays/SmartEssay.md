...
Kevin B
 4 hours ago
```
As you can see in this example the user who posts the question is quite polite in his request, but nonetheless because he provides little to no information on what the problem he's having, with the only details being the compiler error message, his post has gotten flagged and closed. Stackoverflow has become much more lax over the years, but at the bare minimum you should still at least provide what you're trying to do/expected results, what os/language you're using, the source code for the segment you are working with, what you have tried and looked into using. 
